...
const LoaderStory = withInfo({
  text:
    "Loading icons weren't around in 1975, but its really hard to build application UIs without a loading icon. This is a simple loader that uses the NASA 1975 colour scheme."
})(() => {
