...
import { NASA_DEFAULT_LOGO_COLOR } from '../../tokens';

/**
 * This logotype is the central element in NASA's visual communications system.
 * Through consistent and repetitive use as a signature device and design element in all of NASA's visual communications, the logotype becomes a visual shorthand which identifies the Agency and symbol ically embodies its activities, achievements and goals.
 * 
 * In the logotype, the letters N-A-S-A are reduced to their most simplified form.
 * The strokes are all of one width, evoking the qualities of unity and technical precision.
 ...
 */
const WormLogo = ({ color = NASA_DEFAULT_LOGO_COLOR, ...restProps }) =>
  <svg
    ...
    {...restProps}
  >
    <title id="title">NASA logo</title>
    <desc id="desc">NASA Logo</desc>
    <g>
      <path
        fill={color}
