...
import { NASA_RED, NASA_DARK, NASA_LIGHT } from '../../tokens';
...
const WormLogo = ({ theme = DEFAULT_THEME, ...restProps }) => {
    const { logoColor } = LOGO_COLORS[theme] || LOGO_COLORS[DEFAULT_THEME];
